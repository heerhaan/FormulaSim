...
namespace FormuleCirkelEntity.Controllers
{
    public class AccountsController : FormulaController
    {
        ...
        [HttpPost]
        public IActionResult ForgotPassword(string feature = "Sorry, this feature is not implemented yet")
        {
            // Used to be async and had a parameter ForgotPasswordModel forgotPasswordModel
            return RedirectToAction("Index", "Home", new { message = feature });
            /*
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordModel resetPasswordModel)
        {
            ...
            var result = await UserManager.ResetPasswordAsync(user, resetPasswordModel.Code, resetPasswordModel.Password);
            if (result.Succeeded)
            {
                return RedirectToAction("ResetPasswordConfirmation");
            }
